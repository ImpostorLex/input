...
![[Active Directory Enumeration.png]]
#### Key Topics
---
...
![[Active Directory Enumeration-1.png]]
...
![[Active Directory Enumeration-2.png]]
...
![[Active Directory Enumeration-3.png]]
...
- TCP 88 ([[Kerberos]]): It is used for authentication in Active Directory - possible attacks are [[Pass-the-Ticket]] and [[Kerberoasting]].
- TCP 135 ([[Remote Procedure Call|RPC]] Endpoint Manager): It might be leveraged to identify services for lateral movement or remote code execution via DCOM.
...
- TCP 389 ([[Lightweight Directory Access Protocol|LDAP]]): It is in plaintext and can be a prime target for enumerating AD Objects, users, and policies. 
...
![[Active Directory Enumeration-4.png]]
...
![[Active Directory Enumeration-5.png]]
...
---
Read what is [[Lightweight Directory Access Protocol]] here before moving. some LDAP servers allow anonymous users to perform read-only queries. This can expose user accounts and other directory information.
...
![[Active Directory Enumeration-7.png]]
...
---
Read this [[Remote Procedure Call]] - RPC services can be accessed over the SMB protocol. When SMB is configured to allow null sessions that do not require authentication, an unauthenticated user can connect to the IPC$ share and enumerate users, groups, shares, and other sensitive information from the system or domain.
...
![[Active Directory Enumeration-8.png]]
