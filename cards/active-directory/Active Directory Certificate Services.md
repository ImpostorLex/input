...
---
It is the Microsoft's [[Public Key Infrastructure (PKI)]] implementation and it can be used as a [[Certificate Authority]] to prove and delegate trust. It has multiple purpose: encrypting file systems, creating and verifying digital signatures, and even user authentication.
