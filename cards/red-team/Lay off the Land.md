...
![[cards/red-team/images/Lay off the Land.png|450]]
...
![[cards/red-team/images/Lay off the Land-1.png|450]]
...
![[cards/red-team/images/Lay off the Land-2.png]]
...
![[Lay off the Land-3.png]]

However, most of the time it will never show all live host as the `arp` table is connection oriented basis.
## Active Directory
---

Read first [[Active Directory]] and then determine if machine is part of a domain:

```C
systeminfo | findstr Domain
```

![[Lay off the Land-4.png]]

Then for enumerating users, groups, services, and more see [[Active Directory Enumeration]] and [[Active Directory Authenticated Enumeration]].
...
![[Lay off the Land5.png]]

Here is what to look for:

![[Lay off the Land5-1.png]]
