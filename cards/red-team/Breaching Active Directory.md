...
- [[Breaching Active Directory#Prerequisites|Fundamental setup and environment requirements such as Windows and Active Directory basics, plus DNS client configuration for targeting the domain.]]
    
- [[Breaching Active Directory#OSINT and Phishing|Collect public credentials and contextual intel (email, GitHub leaks) and run phishing to harvest logins or deliver RATs for initial access.]]
    
- [[Breaching Active Directory#NTLM Authenticated Services|Test harvested credentials against exposed services using safe spraying techniques (password spraying, custom scripts or hydra) rather than brute force to avoid lockouts.]]
    
- [[Breaching Active Directory#LDAP Bind Credentials|Abuse service LDAP binds and perform LDAP pass-back by hosting a rogue LDAP endpoint with slapd to capture cleartext or hash material from misconfigured devices.]]
    
- [[Breaching Active Directory#Authentication Relays|Intercept and capture NetNTLM via LLMNR/NBT-NS/WPAD poisoning with Responder, crack hashes with hashcat, or perform NTLM relays when SMB signing is not enforced.]]
    
- [[Breaching Active Directory#Microsoft Deployment Toolkit|Enumerate and retrieve PXE/MDT artifacts via nslookup, TFTP, and PowerPXE to extract BCD/WIM files and recover embedded credentials or implant images.]]
    
- [[Breaching Active Directory#Mitigations|Defensive countermeasures: reduce internet exposure of AD services, enforce SMB signing and least-privilege, deploy NAC, and strengthen user training to reduce credential theft.]]
## Prerequisites
...
![[Breaching Active Directory-12.png]]
...
Any public information available that can be used to authenticate such as email, hardcoded credentials in Github, and [[Reconnaissance - Red Team|more]].
...
---
Read first: [[New Technology LAN Manager (NTLM)]] 
...
![[cards/red-team/images/Breaching Active Directory.png]]
...
---
Read first: [[Lightweight Directory Access Protocol]]
...
![[Breaching Active Directory-1.png]]
### Pass-back attacks
---
...
![[Breaching Active Directory-2.png|450]]
...
![[Breaching Active Directory-3.png]]
...
![[Breaching Active Directory-4.png]]
...
![[Breaching Active Directory-6.png]]
...
![[Breaching Active Directory-5.png]]
...
![[Breaching Active Directory-13.png]]
...
![[Breaching Active Directory-11.png]]
...
![[Breaching Active Directory-14.png]]
...
![[Breaching Active Directory-15.png]]
...
Now that we have breached active Directory: next step is to perform [[Enumerating Active Directory (Authenticated Enumeration)|enumeration of Active Directory]] to gain a better understanding of the domain structure and identify potential misconfigurations that can be exploited.
