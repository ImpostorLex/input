...
---
Two of the obstacles adversaries have to face are Antivirus engines and Endpoint Detectin & Response (EDR) solutions, both will leverage an extensive database of known signatures referred to as [[How Antivirus works and gets bypassed#Detection Techniques|static and heuristic signatures]].

To evade signatures adversaries abuse data obfuscation practices then applied it to the **code-element** layer:

![[Obfuscation Principles-2.png|450]]
...
See [[Signature Evasion|signature evasion]] and [[Evading Antivirus - Shellcode#Encoding and Encryption|evading antivirus]] start from encoding and encryption there.
...
![[Obfuscation Principles-3.png|450]]
...
In C# (a compiled binary) Instead of this -- [[Obfuscation Principles Object Name Code]]:  (Code 1)

```C
string leaked = "This was leaked in the strings";
```

An attacker might use [[Obfuscation Principles Object Name Code#obfuscated Code 2|Obfuscated code 2]]:
...
### File & Compilation Properties
---
Though often considered as minor detail, the compilation method could help analyst during reverse engineering, such as if a program is compiled as a [[Obfuscation Principles Object Name Code|debug build]], it may include symbol information that reveals **global variables**, **function names**, **entry points**, and more.
